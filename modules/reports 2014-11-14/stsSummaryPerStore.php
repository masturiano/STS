...
switch($_GET['action']){	
	...
	case 'PrintXls':
			echo "window.open('stsSummaryPerStore_XLS.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
...
<script type="text/javascript">
	$(function(){		
		...
		$("#txtSup").autocomplete({
			source: "stsSummaryPerStore.php?action=searchSupplier",
			minLength: 1,
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">STS SUMMARY PER STORE</h2>
