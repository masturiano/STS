...
switch($_GET['action']){	
	...
	case 'Print':
			echo "window.open('onHoldSts_xls.php?{$_SERVER['QUERY_STRING']}');";	
	exit();
	break;
}
...
<script type="text/javascript">
	$(function(){
		...
		$("#txtSup").autocomplete({
			source: "onHoldSts.php?action=searchSupplier",
			minLength: 1,
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">STS CONDITIONAL REPORT</h2>
<div class="ui-widget-content" style="padding:5px;">
	<table width="50%" border="0" cellspacing="3" cellpadding="2">
    	...
    	<tr>
            ...
            <td colspan="4" align="center"> <button id="printInqXls">Print</button></td>
        </tr>
	</table>
