...
switch($_GET['action']){	
	case 'Print':
		echo "window.open('supplierNotToBeUse_xls.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
}
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">SUPPLIER NOT TO BE USE</h2>
