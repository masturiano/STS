...
ORDER BY tblGroup.grpDesc";	
	...
	function getPendingSts(){
		$sql = "SELECT   top 100  tblStsHdr.stsRefno, tblStsHdr.suppCode, tblStsHdr.stsPaymentMode, tblStsHdr.dateEntered, tblUsers.userName, tblStsHdr.stsAmt, tblStsHdr.stsRemarks
FROM         tblStsHdr INNER JOIN
                      tblUsers ON tblStsHdr.enteredBy = tblUsers.userId where tblStsHdr.pendingStat = 'P'";
		return $this->getArrRes($this->execQry($sql));	  	
	}
}