...
switch($_GET['action']) {
	case "printPending":
			echo "window.open('pending_sts_pdf.php?{$_SERVER['QUERY_STRING']}');";
		exit();
	break;	
...
function PrintPending() {
		...
		$.ajax({
			url: 'pendingSts.php?action=printPending',
			type: "GET",
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">PEDNING STS REPORT</h2>
<div class="ui-widget-content" style="padding:5px;">
        ...
        <table width="80%" border="0" cellspacing="0" cellpadding="0">
            <tr>
               ...
               <td align="center"><button id="printInq" onclick="PrintPending();">Print Pending STS</button> </td>
            </tr>
          </table>
