...
switch($_GET['action']){	
	...
	case 'PrintBR':
		echo "window.open('approved_sts_excel_by_branch.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
	
	case 'PrintSUP':
		echo "window.open('approved_sts_excel_by_supp.php?{$_SERVER['QUERY_STRING']}');";
	exit();
	break;
}
...
<h2 class="ui-widget-header ui-corner-all" style="padding:5px;">STS APPROVED REPORT</h2>
