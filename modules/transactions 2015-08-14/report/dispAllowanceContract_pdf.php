...
class PDF extends FPDF
{
	...
	function Content($arrContract) {
        ...
        */
        if($arrComp == 810){
            $this->Image('../../../images/NE1.jpg',60,8,100);  
            //$this->Image('../../../images/compE.jpg',100,8,20);
        }
        else if($arrComp == 811){
            $this->Image('../../../images/NE2.jpg',60,8,100);  
            //$this->Image('../../../images/compE.jpg',100,8,20);
        }
        else
        {
		...
		$this->Ln(1);
		$this->SetFont('Arial', 'B', '12');
		$this->Cell(65,5,"Vat amount (12%) ",0,0,'L');	
		$this->SetFont('Arial', 'B', '11');
		$this->Cell(100,5,"Php ".number_format($arrContract['stsVatAmt'],2),0,1,'L');

		$this->Ln(1);
		$this->SetFont('Arial', 'B', '12');
		$this->Cell(65,5,"Total Amount Payable: ",0,0,'L');	
		$this->SetFont('Arial', 'B', '11');
		$this->Cell(100,5,"Php ".number_format($arrContract['stsVatAmt']+$arrContract['stsAmt'],2),0,1,'L');
		...
		if($arrContract['vatTag'] == "Y"){
		$this->SetFont('Arial', 'B', '12');
		$this->Cell(65,5,"* ",0,0,'L');	
		$this->SetFont('Arial', '', '11');
		$this->Cell(100,5,'Subject to issuance of Official Receipt (OR)',0,1,'L');
		}else{
		$this->SetFont('Arial', 'B', '12');
		$this->Cell(65,5,"* ",0,0,'L');	
		$this->SetFont('Arial', '', '11');
		$this->Cell(100,5,'Subject to issuance of Collection Receipt(CR)',0,1,'L');	
		}
		...
		$this->Ln(1);
		$this->MultiCell(200,6,"2. The company agrees to maintain cleanliness, orderliness, attractive and appealing visual standards in the display area.");
		$this->Ln(1);
