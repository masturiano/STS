...
WHERE     (sql_mmpgtlib.dbo.APSUPP.ASNUM LIKE '%$terms%') AND (sql_mmpgtlib.dbo.APSUPP.ASNAME NOT LIKE '%NTBU%')
...
WHERE     (tblStsDtl.stsRefno = $refNo)";
	...
	function updateHeader($arr){
        ...
        //Add by mydel april 07 2015
        $onHoldCount = "select holdingDate,onHoldCount From tblStsHdr where stsrefno = {$arr['refNo']}";
