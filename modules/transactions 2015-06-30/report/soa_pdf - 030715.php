...
class PDF extends FPDF
{
	...
	function Content($arrSOA) {
		...
		$addMonth = $_GET['seq'] - 1;
		$dueDate = date("F d, Y", strtotime($arrSOA['applyDate']." +".$addMonth." month", time()));
		$this->Cell(39,4,date('F d, Y',strtotime($dueDate)),1,0,'C',0);
...
$arrFundsInfo = $transObj->getSOAInfo($_GET['refNo'],$_GET['seq']);
$arrFundsInfoArr = $transObj->getSOAInfo2($_GET['refNo'],$_GET['seq']);
