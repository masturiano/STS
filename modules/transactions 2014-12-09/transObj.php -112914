...
WHERE     (tblStsApply.suppCode IN
	...
	function getSOAInfo($refNo) {
		$sqlSOA = "
		select h.stsRefno,h.nbrApplication,h.dateEntered,h.suppCode,h.applyDate,sum(ar.stsApplyAmt) as stsApplyAmt,h.stsRemarks,
		d.deptDesc,
		s.asname
		from tblStsHdr h
