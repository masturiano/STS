...
class PDF extends FPDF
{
	...
	function Content($arrContract) {
		...
		$arrComp = $allowanceObj->getMaxCom2($_GET['refNo']);
		...
		$this->Ln(1);
		$this->SetFont('Courier', 'B', '10');
		$this->Cell(40,5,"Rental Fee: ",0,0,'L');	
		$this->SetFont('Courier', '', '10');
		$this->Cell(100,5,"Php ".$arrContract['stsAmt'],0,1,'L');
		$this->Ln(1);
		$this->SetFont('Courier', 'B', '10');
		$this->Cell(40,5,"VAT: ",0,0,'L');	
		$this->SetFont('Courier', '', '10');
		$this->Cell(100,5,"Php ".round($arrContract['stsAmt2']-$arrContract['stsAmt'],2),0,1,'L');
		
		$this->Ln(1);
		$this->SetFont('Courier', 'B', '10');
		$this->Cell(40,5,"Total Rental Fee: ",0,0,'L');	
		$this->SetFont('Courier', '', '10');
		$this->Cell(100,5,"Php ".$arrContract['stsAmt2'],0,1,'L');
