...
FROM         tblStsDlyAp left JOIN
					...
					foreach($arrContent as $valCon){
						...
						if( $valCon['compCode']<>'809') {
							...
							$contents .= $valCon['hierarchyDesc']." ".substr($valCon['stsRemarks'],0,100)."|";
							$contents .= date("d-M-Y",strtotime($valCon['stsApplyDate']))."|";
							$contents .= date("d-M-Y",strtotime($valCon['stsApplyDate']))."|";
							$contents .= date("d-M-Y")."|";
							$contents .= "STS|";
...
//						}
						...
						if( (int)$valCon['compCode']<>809 ) {
							...
							$contents .= date("d-M-Y",strtotime($valCon['stsApplyDate']))."|";
							$contents .= $prefix.$valCon['stsNo']."-".$valCon['stsSeq']."|";
							$contents .= $prefix.$valCon['stsNo']."-".$valCon['stsSeq']." ".$valCon['shortDesc']." ".substr($valCon['stsRemarks'],0,100)."|";
							$contents .= "1|";
							$contents .= $valCon['stsApplyAmt']."|";
							$contents .= "|";
							$contents .= "PHP|";
