...
FROM         tblStsDlyAp left JOIN
					...
					foreach($arrContent as $valCon){
						...
						if( $valCon['compCode']=='101' || $valCon['compCode']=='102'|| $valCon['compCode']=='103'|| $valCon['compCode']=='104'|| $valCon['compCode']=='105' || $valCon['compCode']=='700') {
							################ Oracle Text File Upload
...
//						}
						...
						if( $valCon['compCode']=='101' || $valCon['compCode']=='102' || $valCon['compCode']=='103' || $valCon['compCode']=='104' || $valCon['compCode']=='105' || (string)$valCon['compCode']=='700') {
							$ctr++;
							$contents .= $prefix.$valCon['stsNo']."-".$valCon['stsSeq']."|";
							$contents .= date("d-M-Y",strtotime($valCon['stsApplyDate']))."|";
							...
							if((float)$valCon['stsVatAmt']!='' || (float)$valCon['stsVatAmt']!=0){
						...
						##### Distribution SETS
							...
							$mmsIDstContent = $mmsIDstContent.
								...
								"\r\n";
							################## if with vat and ewt
							if( ((float)$valCon['stsVatAmt']!='' || (float)$valCon['stsVatAmt']!=0) && (int)$valCon['strCode']!=302 ){
								##### VAT
								$mmsIDstContent = $mmsIDstContent.
								$subLedger2[1].",". ##subledger
								$custCode['ASRCUS'].",". ####customer no
