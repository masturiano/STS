...
class PDF extends FPDF
{
	function Main($arr)
	{
		...
		$reportsObj = new reportsObj();
			if($_GET['cmbType']=='AP'){
				...
				foreach ($arr as $val) {
					$this->SetFont('Arial', '', '9');
					$this->Cell(20,5,' '.$val['InvNo'],0,0,'L');
					$this->Cell(5,5,'',0,0,'L');
					$this->Cell(22,5,number_format($val['stsApplyAmt'],2),0,0,'R');
					$this->Cell(5,5,'',0,0,'L');
					$this->Cell(15,5,number_format($val['stsVatAmt'],2),0,0,'R');
					$this->Cell(12,5,'',0,0,'L');
					$this->Cell(55,5,' '.substr($val['Supplier'],0,25),0,0,'L');
					$this->Cell(50,5,' '.$val['Store'],0,0,'L');
					$this->Cell(25,5,'',0,0,'L');
					$this->Cell(60,5,' '.$val['hierarchyDesc'],0,0,'L');
					$this->Cell(20,5,date('m/d/Y',strtotime($val['stsApplyDate'])),0,0,'L');
					$this->Cell(5,5,'',0,0,'L');
					$this->Cell(20,5,date('m/d/Y',strtotime($val['uploadDate'])),0,1,'L');
				}
			}
	...
	function Header() {
		...
		$this->Ln(5);
		$this->Cell(30,8,'Invoice No.','BT',0,'L');
		$this->Cell(20,8,'Amount','BT',0,'L');
		$this->Cell(45,8,'Vat Amount','BT',0,'L');
		$this->Cell(60,8,'Supplier','BT',0,'L');
		$this->Cell(72,8,'Store','BT',0,'L');
		$this->Cell(43,8,'Hierarchy','BT',0,'L');
		$this->Cell(23,8,'Apply Date','BT',0,'L');
		$this->Cell(20,8,'Upload Date','BT','0','L');
		$this->Cell(13,8,'','BT','1','L');
		}	
	}
