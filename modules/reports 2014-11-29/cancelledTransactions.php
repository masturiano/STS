...
<div class="ui-widget-content" style="padding:5px;">
	<table width="100%" border="0" cellspacing="3" cellpadding="2">
    	...
    	<tr>
            ...
            <td class="hd">Cancel Type:</td>
            <td><? $reportsObj->DropDownMenu($reportsObj->makeArr($reportsObj->findCancelType(),'cancelId','cancelDesc','ALL'),'cmbCancelType','','class="selectBox"'); ?></td>
        </tr>
        </form>
        <tr>
