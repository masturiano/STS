...
if ($_GET['action']=='logout') {
	unset($_SESSION['sts-userId'],$_SESSION['sts-userLevel'],$_SESSION['sts-username'],$_SESSION['sts-minCode'],$arrLogIn['fullName'],$_SESSION['sts-company']);	
    ...
    <tr>
      ...
      <td width="68%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="1%" class="topText">:</td>
          <td width="31%" class="topText"><span id="ModName" name="ModName"></span></td>
          <td width="5%"  class="topLabel">DATE</td>
          <td width="1%" class="topText">:</td>
          <td width="15%" class="topText"><?=strtoupper(date("F d, Y"))?></td>
          
          <? $deptName = $common->getDepartmentName($_SESSION['sts-userId']); ?>
          <td width="10%" rowspan="1"  class="topLabel">DEPARTMENT</td>
          <td width="1%" class="topText">:</td>
          <td width="50%" class="topText"><? echo $deptName['grpDesc']; ?></td>
        </tr>
        <tr>
          ...
          <td class="topText">
		  <?php
		  	if((int)$_SESSION['sts-userId']==29){
				echo "GANDANG ".strtoupper($_SESSION['sts-fullName']);
			}else{
				echo strtoupper($_SESSION['sts-fullName']);
			}
        ...
        <tr>
          ...
          <td class="topText">&nbsp;</td>
          <td class="topText">&nbsp;</td>
          <td class="topLabel">COMPANY</td>
          <? $arrComp = array('1'=>"PUREGOLD GROUP",'2'=>"NE GROUP");?>
          <td class="topText">:</td>
          <td class="topText"><? echo $arrComp[$_SESSION['sts-company']];?></td>
        </tr> 
      </table></td>
    </tr>
  </table>
