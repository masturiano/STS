...
if ($_GET['action']=='login') {
	...
	if ($arrLogIn['userId'] != '') {
		...
		$_SESSION['sts-company']	 	= $_GET['cmbCompany'];
        $_SESSION['sts-conditional']         = $arrLogIn['conditional'];
        $_SESSION['sts-isManager']         = $arrLogIn['isManager'];
...
$arrComp = array('0'=>"",'1'=>"PUREGOLD GROUP",'2'=>"NE GROUP");
?>
...
<form name="LoginForm" id="LoginForm" >
        <table width="480" border="0" cellspacing="0" class="ui-corner-all ui-dialog-content" style="background:#FFFFFF; padding:20px;" cellpadding="0" id = "logintable">
          ...
          <tr>
            ...
            <td width="150" rowspan="6"><img align="absmiddle" src="images/Unlock-icon.png" width="100"/></td>
          </tr>
          <tr>
          ...
          <tr>
            <td height="25"><span class="style13">Company </span> <span id="errpword" class="errSpan" name="errpword"></span>
          </tr>
          <tr>
            <td><? $common->DropDownMenu($arrComp,'cmbCompany','','class="selectBox"'); ?></td>
          </tr>
          <tr>
            <td height="25">&nbsp;</td>
            <td>&nbsp;</td>                                         
